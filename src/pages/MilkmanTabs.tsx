...
import { HomeIcon, RouteIcon, UsersIcon, HistoryIcon, UserIcon } from '../components/icons/Icon';
import type { TabItem } from '../components/TabBar';
import { MilkmanHomePage } from './MilkmanHome';
import { MilkmanRoutesPage } from './MilkmanRoutes';
...
const TAB_ITEMS: TabItem[] = [
  ...
  { key: 'Rotas', label: 'Rotas', renderIcon: (c) => <RouteIcon size={24} color={c} /> },
